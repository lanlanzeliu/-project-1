...
public class HW6{
   ...
   public static void main (String [] args) throws IOException {
      ...
      HW6 choose = new HW6();
      System.out.println("Please choose Integer or RealNumber or String:");
   ...
   public void chooseInteger(PrintWriter outputFile){
      ...
      outputFile.println("\nThis is not right");  
         ...
         Object[] temp = new Object[inputArray.length];
         for(int i = 0; i < inputArray.length; i++){
            temp[i] = (Integer) inputArray[i];
         }
         
          mn.mergeSortTime(temp);
...
/*******************************/
   ...
   public  void chooseString(PrintWriter outputFile){
      ...
      outputFile.println ("\nThis is not right");
         ...
         Object[] temp = new Object[mb.length];
